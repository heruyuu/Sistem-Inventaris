    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="statisBackdropLabel">Add Data</h5>
            ...
            <div class="modal-body">
                <form id="data_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label selected>Asal Perolehan</label>
                                <select name="school_operational_id" id="school_operational_id" class="custom-select">
                                    <option>:: Pilih ::</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="price_per_item" id="price_per_item" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
